#overlap of DLX5, MEIS and LHX6 peaks in mouse GE

## published data data from Lindtner et al., 2019 & Sandberg et al., 2016
...
setwd("/home/volker.kittke/DLX_and_MEIS_binding_mouse_embryo/scripts/final_scripts_for_Christian/input_data/")
####################
#Dlx5
...
# liftOver Dlx5 from mm9 to mm10
...
#3300 (= unfiltered peaklist) -> paper lists 2429 peaks
...
# returns 2428 peaks -> paper states 2429 
...
###################
#################
#### create merged peaklist by combining all peaks in one dataset, merging overlapping peaks and assigning "merged peak name"
